const InfoView = () => {
  return (
    <article className='max-w-2xl px-6 pt-5 mx-auto space-y-12  dark:text-gray-50'>
      <div className='w-full mx-auto space-y-4 text-center'>
        <p className='text-xs font-semibold tracki uppercase'>
          #Ecommerce-admin
        </p>
        <h1 className='text-4xl font-bold leadi md:text-5xl'>
          Front-end Web Developer Task - August 2023
        </h1>
        <p>
          for <i>"Personel Project" </i>{' '}
        </p>
      </div>
      <a
        rel='noopener noreferrer'
        href='https://github.com/Nayem707/02-Ecommerce-admin-front'
        target='blank'
        aria-label='GitHub'
      ...
      <div className='pt-5 pb-5 border-t dark:border-gray-700'>
        <div className='flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row'>
          ...
          <div className='flex flex-col'>
            <h4 className='text-lg font-semibold'>Nayem Islam</h4>
            <p className='dark:text-gray-400'>
